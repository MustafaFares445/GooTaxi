...
use App\Http\Requests\CheckOfferRequest;
...
final class CheckOfferController
{
     ...
     */
    public function __invoke(CheckOfferRequest $request): HttpResponse|JsonResource
    {
        ...
        return OfferResource::make(Offer::query()->findOrFail($offerId))
