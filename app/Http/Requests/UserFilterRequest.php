...
final class UserFilterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'filter.isAdmin' => 'sometimes|string|max:255',
            ...
            'sort' => 'sometimes|string|in:name,-name,email,-email,phoneNumber,-phoneNumber,isAdmin,-isAdmin,emailVerifiedAt,-emailVerifiedAt,password,-password,rememberToken,-rememberToken',
        ];
    }
}
